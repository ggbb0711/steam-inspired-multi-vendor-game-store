...
editGameRouter.put('/:gameId',fileUploader.fields([{name:'uploadThumbnailImage',maxcount:1},{name:'uploadCarouselImages',maxcount:8}]),deJson(['genres','thumbnailImage','carouselImages','deletedCarouselImages','deletedThumbnailImages']),
