...
function AddImgCarousel({imgArr,style,maxfile,handleUploadImg,handleDeleteImg,handleChangeImg}){
...
function useImgFiles(maxfile){
    ...
    return [imgFiles,handleUploadImg,deletedFiles,handleDeleteImg,handleChangeImg]
}

export { useImgFiles, AddImgCarousel }